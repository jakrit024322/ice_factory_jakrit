package nvc.it.ice_factory_jakrit.controller;
...
import nvc.it.ice_factory_jakrit.service.CameraService;
...
public class CameraController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Object> updateEvents(@PathVariable String id, @RequestBody Event event){
        HashMap<String, Object> map = new HashMap<>();
    ...
    /////////////////////////////////////////////////////////////////////////////
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateProduct(@PathVariable String id, @RequestBody Camera camera){
        HashMap<String, Object> map = new HashMap<>();
